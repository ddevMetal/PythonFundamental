...
• a+  - append and read: creates cfile, reads anywhere, writes at end
...
#3️⃣ Append Text
#---------------------------------------------------------
path = r'C:\Users\tchou\GitHub\pythonProj\PythonFundamental\PyBasic\NewFolder\Folder_B'
filename = 'example.txt'
